...
class DashboardScreen extends StatelessWidget {
  ...
  Widget dashboardButton(BuildContext context, IconData icon, String label, VoidCallback onPressed) {
...
class CustomTextField extends StatelessWidget {
  ...
  CustomTextField({required this.hintText, this.obscureText = false, required this.controller});
